...
class MobileEsp {
	...
	constructor(uagent) {
		this.uagent = uagent.toLowerCase();
		...
		this.deviceWebOS = 'webos', //For Palm devices 
		this.deviceWebOStv = 'web0s', //For LG TVs
		...
		this.deviceSailfish = 'sailfish', //Sailfish OS
		this.deviceUbuntu = 'ubuntu', //Ubuntu Mobile OS
		...
		//Smart TV strings
		this.smartTV1 = 'smart-tv'; //Samsung Tizen smart TVs
		this.smartTV2 = 'smarttv'; //LG WebOS smart TVs
